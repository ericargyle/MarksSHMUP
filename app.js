...
let bullets=[],eBullets=[],enemies=[],particles=[],boss=null,keys={},fireCd=0,spawnCd=0,terrainScroll=0,bossT=0;
...
function drawBullets(){ bullets.forEach(b=> b.laser ? rect(b.x,b.y,b.w,b.h,'#f6ff85') : circle(b.x,b.y,4*dpr,'#fff8df')); eBullets.forEach(b=> circle(b.x,b.y,4*dpr,'#ffca72')); }
